  ...
  if(! filter_var($Id, FILTER_VALIDATE_EMAIL)) {
    ...
    $error = "Invalid Email";
        ...
        if ($count > 0) {
            ...
            $sql="INSERT INTO `Login` (`Id`, `Password`, `Type`) values('".$Id."','".$passwd."','".$Type."');";
            mysqli_query($conn,$sql);

            $msg = "Registration is sucessfull!!!";

            // use wordwrap() if lines are longer than 70 characters
            $msg = wordwrap($msg,70);

            // send email
            mail($Id,"Registration",$msg);
  ...
  <div class="site-wrap">
    ...
    <div class="unit-5 overlay" style="background-image: url('images/hero_bg_1.jpg');">
      <div class="container text-center">
        ...
        <p class="mb-0 unit-6"><span>Registration</span></p>
      </div>
    </div>
        ...
        <div class="row">
          ...
          <div class="col-md-12 col-lg-6 mb-5" style="margin : 0% 25%">
            ...
            <form class="p-5 bg-white" method="POST">
                ...
                <div class="col-md-12">
                  <label class="font-weight-bold" for="type">Student/Supervisor</label> : <br/>
                  <input type="radio" name="type" id="type" value="s1" checked>Student <br/>
                  <input type="radio" name="type" id="type" value="s2"> Supervisor <br/>
                </div>
              </div>
             
              <div class="row form-group">
                <div class="col-md-12">
                  <label class="font-weight-bold" for="CusId">Id</label> : <input type="text" name="id" id="id" placeholder="Email Address" required>
                </div>
                <div class="col-md-12">
                <label class="font-weight-bold" for="Pass">Password</label> : <input type="text" name="Password" id="password" required>
                </div>
              </div>
