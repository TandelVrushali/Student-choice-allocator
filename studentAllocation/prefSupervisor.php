      ...
      <div class="collapse navbar-collapse" id="navbarsExampleDefault">
        <ul class="navbar-nav mr-auto">
          <li class="nav-item active">
            <a class="nav-link" href="prefSupervisor.php">Supervisor Preference<span class="sr-only">(current)</span></a>
          </li>
        </ul>
                    ...
                    while($count > 0) 
                        {
                            while($row = mysqli_fetch_assoc($result))
                            {
                              ...
                              echo "<tr>
                                      ...
                                      <td>$c3</td>
                                      <td>$c4</td>
                                      <td><center><a href=deleteSupervisor.php?name=$Id class='btn btn-info btn-sm'>
