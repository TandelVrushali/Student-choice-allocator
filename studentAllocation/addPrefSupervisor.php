...
if(isset($_POST["submit"]))
{
   ...
   if($c1==$c2){
    ...
    $sql= "SELECT * FROM supervisorChoice WHERE Id='".$Id."';";
   ...
   if($flag==0){
    ...
    if($count>0){
        ...
        if ($Confirmation == true) {
           $sql = "UPDATE `supervisorChoice` SET choice1='".$c1."', choice2='".$c2."', choice3='".$c3."',choice4='".$c4."' WHERE Id='".$Id."';";
        ...
        $sql="INSERT INTO supervisorChoice (Id, choice1, choice2, choice3, choice4) values('".$Id."','".$c1."','".$c2."','".$c3."','".$c4."');";
        mysqli_query($conn,$sql);
  ...
  <div class="site-wrap">
      ...
      <div class="site-navbar bg-dark">
        <div class="container py-1">
          <div class="row align-items-center">
            ...
            <a href="supervisor.html" class="btn btn-outline-light my-2 my-sm-2" role="button"style="margin:5px;">Home</a>
    ...
    <div class="unit-5 overlay" style="background-image: url('images/hero_bg_1.jpg');">
      <div class="container text-center">
        <h2 class="mb-0">Add Supervisor Prefrence</h2>
        <p class="mb-0 unit-6"><span>Supervisor prefrence</span></p>
      </div>
    </div>
