...
if(isset($_POST["register"]))
{
  ...
  $capacity = $_POST["capacity"];
    ...
    $sql="INSERT INTO `Topic` (`TId`, `Name`, `Capacity`,`Approved`) values('".$TId."','".$name."','".$capacity."','N');";
        ...
        <div class="container py-1">
          <div class="row align-items-center">
            ...
            <div class="col-8 col-md-8 col-lg-4 text-right">
              <a href="supervisor.html" class="btn btn-outline-light my-2 my-sm-2 rounded-0 " style="margin: 5px">Home</a>
            </div>
