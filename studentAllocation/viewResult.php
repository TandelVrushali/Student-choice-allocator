    ...
    <nav class="navbar navbar-expand-md navbar-dark bg-dark fixed-top">
      ...
      <div class="collapse navbar-collapse" id="navbarsExampleDefault">
        <ul class="navbar-nav mr-auto">
          ...
          <a class="nav-link" href="viewResult.php">View Result<span class="sr-only">(current)</span></a>
          </li>
        </ul>
      ...
      <div class="starter-template">
        <?php
            ...
            if($count>0)
            {
                ...
                if($row['resultOut']=='Y'){
                    $sql="SELECT * FROM Allocation ORDER BY GroupNo;;";
                    $result = mysqli_query($conn,$sql);
                    $count=mysqli_num_rows($result);
                        ...
                        while($count > 0) 
                            {
                                while($row = mysqli_fetch_assoc($result))
                                {
                                  ...
                                  if($Type=="s1"){
                                    $Type = "<strong style='font-size:100%; color:brown'>Student</strong>";
                                   }
                                   if($Type=="s2"){
                                    $Type = "<strong style='font-size:100%; color:green'>Supervisor</strong>";
                                   }
                ...
                echo "<br><br><br><br><center><strong style='font-size:150%; color:brown'>Allocation is not published yet</strong></center>";
                    ...
                    echo "<center><strong style='font-size:150%; color:brown'>Result is not published!!!</strong></center>";
                }
